...
export default function App() {
  ...
  return (
    ...
    <section>
      ...
      <TodoList todos={todos} toggleTodo={toggleTodo} deleteTodo={deleteEachTodo} editTodo={openEditDialog} />
    </section>
    {edit && createPortal(<EditTodoForm  onSubmit={editTodo} closeEditDialog={closeEditDialog} edit={edit}/>, document.body)}
    </>
  )
}